...
namespace rmmseg
{
    Token ComplexAlgorithm::next_token()
    {
    ...
    Token ComplexAlgorithm::get_basic_latin_word()
    {
        int len = 1;
        int start, end;
    ...
    Token ComplexAlgorithm::get_cjk_word(int len)
    {
        m_tmp_words_i = 0;
    ...
    vector<Chunk> ComplexAlgorithm::create_chunks()
    {
        vector<Chunk> chunks;
        Chunk chunk;
        Word *w1, *w2, *w3;
    ...
    int ComplexAlgorithm::next_char()
    {
        // ONLY for UTF-8
    ...
    Word *ComplexAlgorithm::get_tmp_word()
    {
    ...
    vector<Word *> ComplexAlgorithm::find_match_words()
    {
        vector<Word *> words;
        Word *word;
        int orig_pos = m_pos;
